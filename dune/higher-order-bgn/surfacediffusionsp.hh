...
public:
  ...
  SDSPLocalAssembler (const Basis&, const GridFct1& X, const GridFct2& Xmid, const GridFct3& Xiter, int quadOrder, double tau)
    : X_(X)
    , Xmid_(Xmid)
    , Xiter_(Xiter)
...
SDSPLocalAssembler(const Basis&, const GridFct1&, const GridFct2&, const GridFct3&, int, double)
  -> SDSPLocalAssembler<typename Basis::LocalView, GridFct1, GridFct2, GridFct3>;
